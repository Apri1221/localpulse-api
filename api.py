...
if __name__ == '__main__':
    ...
    print(f"   - http://localhost:8000/api/health")
    print(f"   - http://localhost:8000/api/chat (POST)")
    print(f"   - http://localhost:8000/api/financial")
    print(f"   - http://localhost:8000/api/poi")
    print(f"   - http://localhost:8000/api/search (POST)")
    print("=" * 50)
