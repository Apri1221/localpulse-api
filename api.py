...
if __name__ == '__main__':
    ...
    print(f"   - http://localhost:8081/api/health")
    print(f"   - http://localhost:8081/api/chat (POST)")
    print(f"   - http://localhost:8081/api/financial")
    print(f"   - http://localhost:8081/api/poi")
    print(f"   - http://localhost:8081/api/search (POST)")
    print("=" * 50)
